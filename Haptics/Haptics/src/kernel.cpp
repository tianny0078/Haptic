...
Kernel::Kernel()
{
	...
	//adaptive
	threshold_energy = 10000;
	threshold_leaf_level = 0;
	runtime = 0.0;
	peNum = 0;
...
void Kernel::linkMesh_VolMesh(Mesh* &m, VoxMesh* &vm, int grid_density_in)
{
	...
	for (node_iterator ni = m->node_list.begin(); ni < m->node_list.end(); ++ni)
	{
		...
		/*
		double temppara = 0.0;
		temppara = (abs(ni->list_interpolation_nodes_6[0]->coordinate.x() - ni->coordinate.x()) 
			* abs(ni->list_interpolation_nodes_6[0]->coordinate.y() - ni->coordinate.y()) 
			* abs(ni->list_interpolation_nodes_6[0]->coordinate.z() - ni->coordinate.z())) / vox_cube;
		 ni->para_interpolate_0.push_back(temppara);
		
		 temppara = (abs(ni->list_interpolation_nodes_7[0]->coordinate.x() - ni->coordinate.x()) 
			* abs(ni->list_interpolation_nodes_7[0]->coordinate.y() - ni->coordinate.y()) 
			* abs(ni->list_interpolation_nodes_7[0]->coordinate.z() - ni->coordinate.z())) / vox_cube;
		 ni->para_interpolate_1.push_back(temppara);

		temppara = (abs(ni->list_interpolation_nodes_4[0]->coordinate.x() - ni->coordinate.x()) 
			* abs(ni->list_interpolation_nodes_4[0]->coordinate.y() - ni->coordinate.y()) 
			* abs(ni->list_interpolation_nodes_4[0]->coordinate.z() - ni->coordinate.z())) / vox_cube;
		ni->para_interpolate_2.push_back(temppara);

		temppara = (abs(ni->list_interpolation_nodes_5[0]->coordinate.x() - ni->coordinate.x()) 
			* abs(ni->list_interpolation_nodes_5[0]->coordinate.y() - ni->coordinate.y()) 
			* abs(ni->list_interpolation_nodes_5[0]->coordinate.z() - ni->coordinate.z())) / vox_cube;
		ni->para_interpolate_3.push_back(temppara); 

		temppara = (abs(ni->list_interpolation_nodes_2[0]->coordinate.x() - ni->coordinate.x()) 
			* abs(ni->list_interpolation_nodes_2[0]->coordinate.y() - ni->coordinate.y()) 
			* abs(ni->list_interpolation_nodes_2[0]->coordinate.z() - ni->coordinate.z())) / vox_cube;
		ni->para_interpolate_4.push_back(temppara); 
		
		temppara = (abs(ni->list_interpolation_nodes_3[0]->coordinate.x() - ni->coordinate.x()) 
			* abs(ni->list_interpolation_nodes_3[0]->coordinate.y() - ni->coordinate.y()) 
			* abs(ni->list_interpolation_nodes_3[0]->coordinate.z() - ni->coordinate.z())) / vox_cube;
		ni->para_interpolate_5.push_back(temppara);

		temppara = (abs(ni->list_interpolation_nodes_0[0]->coordinate.x() - ni->coordinate.x()) 
			* abs(ni->list_interpolation_nodes_0[0]->coordinate.y() - ni->coordinate.y()) 
			* abs(ni->list_interpolation_nodes_0[0]->coordinate.z() - ni->coordinate.z())) / vox_cube;
		ni->para_interpolate_6.push_back(temppara);

		temppara = (abs(ni->list_interpolation_nodes_1[0]->coordinate.x() - ni->coordinate.x()) 
			* abs(ni->list_interpolation_nodes_1[0]->coordinate.y() - ni->coordinate.y()) 
			* abs(ni->list_interpolation_nodes_1[0]->coordinate.z() - ni->coordinate.z())) / vox_cube;
		ni->para_interpolate_7.push_back(temppara); 
		*/
		}
		else
		{
...
void Kernel::linkNeighbor4Cluster(VoxMesh * vm)
{
	vector<Cluster>::iterator ci = vm->cluster_list.begin();
	for (; ci != vm->cluster_list.end(); ci++)
	{
		ci->neighbor_list.clear();
		int idx = 0;
		//1
		if (ci->vox_list[0]->back_neighbor)
		{
			idx = ci->vox_list[0]->back_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//2
		if (ci->vox_list[0]->bottom_back_neighbor)
		{
			idx = ci->vox_list[0]->bottom_back_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//3
		if (ci->vox_list[0]->bottom_front_neighbor)
		{
			idx = ci->vox_list[0]->bottom_front_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//4
		if (ci->vox_list[0]->bottom_left_back_neighbor)
		{
			idx = ci->vox_list[0]->bottom_left_back_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//5
		if (ci->vox_list[0]->bottom_left_front_neighbor)
		{
			idx = ci->vox_list[0]->bottom_left_front_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}	
		//6
		if (ci->vox_list[0]->bottom_left_neighbor)
		{
			idx = ci->vox_list[0]->bottom_left_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}	
		//7
		if (ci->vox_list[0]->bottom_neighbor)
		{
			idx = ci->vox_list[0]->bottom_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}		
		//8
		if (ci->vox_list[0]->bottom_right_back_neighbor)
		{
			idx = ci->vox_list[0]->bottom_right_back_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//9
		if (ci->vox_list[0]->bottom_right_front_neighbor)
		{
			idx = ci->vox_list[0]->bottom_right_front_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//10
		if (ci->vox_list[0]->bottom_right_neighbor)
		{
			idx = ci->vox_list[0]->bottom_right_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//11
		if (ci->vox_list[0]->front_neighbor)
		{
			idx = ci->vox_list[0]->front_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//12
		if (ci->vox_list[0]->left_back_neighbor)
		{
			idx = ci->vox_list[0]->left_back_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//13
		if (ci->vox_list[0]->left_front_neighbor)
		{
			idx = ci->vox_list[0]->left_front_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//14
		if (ci->vox_list[0]->left_neighbor)
		{
			idx = ci->vox_list[0]->left_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//15
		if (ci->vox_list[0]->top_back_neighbor)
		{
			idx = ci->vox_list[0]->top_back_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//16
		if (ci->vox_list[0]->top_front_neighbor)
		{
			idx = ci->vox_list[0]->top_front_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//17
		if (ci->vox_list[0]->top_left_back_neighbor)
		{
			idx = ci->vox_list[0]->top_left_back_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//18
		if (ci->vox_list[0]->top_left_front_neighbor)
		{
			idx = ci->vox_list[0]->top_left_front_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//19
		if (ci->vox_list[0]->top_neighbor)
		{
			idx = ci->vox_list[0]->top_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//20
		if (ci->vox_list[0]->top_right_back_neighbor)
		{
			idx = ci->vox_list[0]->top_right_back_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//21
		if (ci->vox_list[0]->top_right_front_neighbor)
		{
			idx = ci->vox_list[0]->top_right_front_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//22
		if (ci->vox_list[0]->top_right_neighbor)
		{
			idx = ci->vox_list[0]->top_right_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//23
		if (ci->vox_list[0]->right_back_neighbor)
		{
			idx = ci->vox_list[0]->right_back_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//24
		if (ci->vox_list[0]->right_front_neighbor)
		{
			idx = ci->vox_list[0]->right_front_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//25
		if (ci->vox_list[0]->right_neighbor)
		{
			idx = ci->vox_list[0]->right_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
		//26
		if (ci->vox_list[0]->top_left_neighbor)
		{
			idx = ci->vox_list[0]->top_left_neighbor->clusterid;
			ci->neighbor_list.push_back(&vm->cluster_list[idx]);
		}
...
void Kernel::generatePerVoxCluster(VoxMesh* &vm)
{
	...
	vm->cluster_adaptive_list.clear();
	...
	for (vox_iterator vi=vm->vox_list.begin(); vi!=vm->vox_list.end(); ++vi)
	{
		...
		vm->cluster_list.back().node_list[0].master_cluster = &vm->cluster_list.back();
		vm->cluster_list.back().node_list[1].master_cluster = &vm->cluster_list.back();
		vm->cluster_list.back().node_list[2].master_cluster = &vm->cluster_list.back();
		vm->cluster_list.back().node_list[3].master_cluster = &vm->cluster_list.back();
		vm->cluster_list.back().node_list[4].master_cluster = &vm->cluster_list.back();
		vm->cluster_list.back().node_list[5].master_cluster = &vm->cluster_list.back();
		vm->cluster_list.back().node_list[6].master_cluster = &vm->cluster_list.back();
		vm->cluster_list.back().node_list[7].master_cluster = &vm->cluster_list.back();
		
		//** adaptive **
		//vm->cluster_list.back().flag_activeCluster = true;
		vm->cluster_adaptive_list.push_back(&vm->cluster_list.back());
		vm->cluster_list.back().flag_leafCluster = true;
		vm->cluster_list.back().flag_activeCluster = true;
		vm->cluster_list.back().index = vm->cluster_list.size() - 1;
		//** adaptive **
...
void Kernel::initializeSimulator()
{
	...
	case NEW_HIERARCHY_SHAPE_MATCHING:
		...
		flag_simulator_ready = true;
		break;
	case ADAPTIVE_HIERARCHY_SHAPE_MATCHING:
		// link duplicate nodes	for all level
		for(int i = 0; i < level_list.size(); i++)
		{
			for (node_iter = level_list[i]->voxmesh_level->node_list.begin(); node_iter != level_list[i]->voxmesh_level->node_list.end(); ++node_iter)
...
bool Kernel::simulateNextStep4ShapeMatching()
{
	...
	//cout << "Step1 initialize: " << time_counter->GetElapsedTime() << endl;
	...
	//************************************************************************
	//test if correct for haptic and ghost node
	//if (level_list[0]->voxmesh_level->haptic_node_list.size() > 0)
	//{
	//	cout << "haptic node" << endl;
	//	cout << level_list[0]->voxmesh_level->haptic_node_list[0].target_position << endl;
	//	cout << level_list[0]->voxmesh_level->haptic_node_list[0].duplicates[0]->target_position << endl;
	//	
	//}

	//if (level_list[0]->voxmesh_level->ghost_node_list.size() > 0)
	//{
	//	cout << "ghost node" << endl;
	//	cout << level_list[0]->voxmesh_level->ghost_node_list[0].target_position << endl;
	//	cout << level_list[0]->voxmesh_level->ghost_node_list[0].duplicates[0]->target_position << endl;
	...
	for (; ci!=p_vox_mesh->cluster_list.end(); ++ci)
	{
		...
		{
			//cout << ci->haptic_node_list.size() << endl;
			vector<DuplicatedNode>::const_iterator hni = ci->haptic_node_list.begin();
			for (; hni != ci->haptic_node_list.end(); ++hni)
			{
				ci->current_center += hni->target_position * hni->mass;
				//cout << "shape matching" << endl;
				//cout << hni->target_position << endl;
				//cout << hni->mapped_node->target_position << endl;
				mass_sum += hni->mass;
			}
		}
		if (ci->ghost_node_list.size() > 0)
		{
			//cout << ci->ghost_node_list.size() << endl;
			vector<DuplicatedNode>::const_iterator hni = ci->ghost_node_list.begin();
			for (; hni != ci->ghost_node_list.end(); ++hni)
			{
				ci->current_center += hni->target_position * hni->mass;
				//cout << "shape matching" << endl;
				//cout << hni->target_position << endl;
		...
		if (ci->haptic_node_list.size() > 0)
		{
			vector<DuplicatedNode>::const_iterator hni;
			for (hni = ci->haptic_node_list.begin(); hni != ci->haptic_node_list.end(); ++hni)
			{
				p = hni->target_position - ci->current_center;
				q = hni->coordinate - ci->original_center;
				ci->a_pq += hni->mass * p * q.transpose();
			}
		}
		if (ci->ghost_node_list.size() > 0)
		{
			vector<DuplicatedNode>::const_iterator gni;
			for (gni = ci->ghost_node_list.begin(); gni != ci->ghost_node_list.end(); ++gni)
			{
				p = gni->target_position - ci->current_center;
				q = gni->coordinate - ci->original_center;
		...
		for (dni=ci->node_list.begin(); dni!=ci->node_list.end(); ++dni)
		{
			...
			if (!dni->mapped_node->flag_anchor_node)
			{
				...
				{
					dni->target_position = dni->static_position + time_step_size * time_step_size * _force * force_scalar/dni->mass;
		...
		if (ci->haptic_node_list.size() > 0)
		{
			vector<DuplicatedNode>::iterator hni;
			for (hni = ci->haptic_node_list.begin(); hni != ci->haptic_node_list.end(); ++hni)
			{
				hni->static_position = (ci->beta*ci->a/det_a + (1.0-ci->beta)*ci->r)*(hni->coordinate - ci->original_center) + ci->current_center;
				hni->mapped_node->static_position = hni->static_position;
				...
				//hni->target_position = hni->static_position;
				//hni->mapped_node->target_position = hni->static_position;
			}
		}
		if (ci->ghost_node_list.size() > 0)
		{
			vector<DuplicatedNode>::iterator gni;
			for (gni = ci->ghost_node_list.begin(); gni != ci->ghost_node_list.end(); ++gni)
			{
				gni->static_position = (ci->beta*ci->a/det_a + (1.0-ci->beta)*ci->r)*(gni->coordinate - ci->original_center) + ci->current_center;
				...
				{
					gni->target_position = gni->static_position;
				}
				gni->mapped_node->static_position = gni->static_position;
				gni->mapped_node->target_position = gni->static_position;
			}
		}
	...
	time_counter->StopCounter();
	//cout << "Step2 sm: " <<time_counter->GetElapsedTime() << endl;
	...
	time_counter->StopCounter();
	//cout << "Step3 average: " <<time_counter->GetElapsedTime() << endl;
	...
	for (node_iterator nmi=p_mesh->node_list.begin(); nmi!=p_mesh->node_list.end(); ++nmi)
	{
		...
		for(int i = 0; i < 8; i++)
		{
			...
			//nmi->displacement += (nmi->list_interpolation_nodes[i][0]->static_position - nmi->list_interpolation_nodes[i][0]->coordinate) * nmi->para_interpolate[i][0];
		}
	}
	
	time_counter->StopCounter();
	//cout << "Step4 interpolation: " <<time_counter->GetElapsedTime() << endl;
	...
	if(flag_setForce && !flag_setWindForce)
	{
		...
		runtime += time_counter->GetElapsedTime();
		...
		p_vox_mesh->new_energy = match_energy;
		if(p_vox_mesh->old_energy != 0)
		{
			double threshold = (p_vox_mesh->new_energy - p_vox_mesh->old_energy)/ p_vox_mesh->old_energy;
			if(abs(threshold) < 0.001 && !flag_converge)
			{
...
Cluster * Kernel::findLeafParent(Cluster * p)
{
	if (p->parent_cluster != NULL)
	{
		if(p->parent_cluster->flag_leafCluster)
			return p->parent_cluster;
		else
			return findLeafParent(p->parent_cluster);
	}
	else
		return NULL;
}

DuplicatedNode * Kernel::findLeafNode4Children(DuplicatedNode * p, int idx_node)
{
	if(p->mapped_node->child_node != NULL)
	{
		vector<Cluster *>::iterator ci = p->mapped_node->child_node->incident_cluster.begin();
		for(; ci != p->mapped_node->child_node->incident_cluster.end(); ci++)
		{
			if((*ci)->parent_cluster == p->master_cluster)
			{
				if ((*ci)->flag_leafCluster)
				{
					return &(*ci)->node_list[idx_node];
				}
				else
				{
					return findLeafNode4Children(&(*ci)->node_list[idx_node], idx_node);
				}
			}
		}
		return NULL;
...
bool Kernel::linkNode4LeafParent(Cluster *p, Vector3d force_gravity, Vector3d force_wind)
{
	Cluster * ptemp = findLeafParent(p);
	if (ptemp == NULL)
	{
		cout << "Error! Cannot find leaf parent" << endl;
		return false;
	}
	ptemp->computeCurrentMassCentroid4Static();
	vector<DuplicatedNode>::iterator dni;
	double det_a = det33(p->a);
	for (dni=p->node_list.begin(); dni!=p->node_list.end(); ++dni)
	{
		Vector3d _force = dni->force + force_gravity + force_wind;;

		dni->static_position = (p->beta*p->a/det_a + (1.0-p->beta)*ptemp->r)*(dni->coordinate - ptemp->original_center) + ptemp->current_center; // + t_ci;//ci->current_center;
...
bool Kernel::linkNode4LeafChildren(Cluster *p)
{
	for (int i = 0; i < p->node_list.size(); i++)
	{
		DuplicatedNode * ptemp = findLeafNode4Children(&p->node_list[i], i);
		if (ptemp == NULL)
		{
			cout << "Error! cannot find leaf child!" << endl;
			return false;
		}
		//p->node_list[i].static_position = ptemp->static_position;
		p->node_list[i].target_position = ptemp->target_position;
	}
	return true;
}

bool Kernel::linkNode4LeafChildren(Cluster *p, Vector3d force_gravity, Vector3d force_wind)
{
	
	int sizeLeaf = p->cluster_list_children.size();
	if (sizeLeaf == 0)
		return 0;
	else if (sizeLeaf > 1)
	{
		Quaterniond q(p->cluster_list_children[0]->r);
		double t_add = 0.0;
		int count = 1;
		p->cluster_list_children[0]->computeCurrentMassCentroid4Static();
		////Vector3d t = m_pcluster->leaf_list[0]->current_center - m_pcluster->leaf_list[0]->r * m_pcluster->leaf_list[0]->original_center;
		Vector3d t = p->cluster_list_children[0]->current_center + p->cluster_list_children[0]->r * (p->original_center - p->cluster_list_children[0]->original_center);
		//translation = (m_pcluster->leaf_list[0]->distanceSuperParent / m_pcluster->term_normlize) * t;
		Vector3d translation = (1.0/sizeLeaf) * t;
		while(count < sizeLeaf)
		{
			p->cluster_list_children[count]->computeCurrentMassCentroid4Static();
			Quaterniond q2(p->cluster_list_children[count]->r);
			//t_add += (m_pcluster->leaf_list[count-1]->distanceSuperParent / m_pcluster->term_normlize);
			t_add += 1.0/sizeLeaf;

			//double temp = t_add / (t_add + (m_pcluster->leaf_list[count]->distanceSuperParent / m_pcluster->term_normlize));
			double temp = t_add / (t_add + (1.0 / sizeLeaf));
			...
			t = p->cluster_list_children[count]->current_center + p->cluster_list_children[count]->r * (p->original_center - p->cluster_list_children[count]->original_center);
			//translation += (m_pcluster->leaf_list[count]->distanceSuperParent / m_pcluster->term_normlize) * t;
			translation += (1.0 / sizeLeaf) * t;

			count ++;
		}
		p->r = q.toRotationMatrix();
		p->current_center = translation;
	}
	else if (sizeLeaf == 1)
	{
		p->cluster_list_children[0]->computeCurrentMassCentroid4Static();
		p->r = p->cluster_list_children[0]->r;
		////translation = m_pcluster->leaf_list[0]->current_center - m_pcluster->leaf_list[0]->r * m_pcluster->leaf_list[0]->original_center;
		p->current_center = p->cluster_list_children[0]->current_center + p->cluster_list_children[0]->r * (p->original_center - p->cluster_list_children[0]->original_center);
	}
	...
	for (dni=p->node_list.begin(); dni!=p->node_list.end(); ++dni)
	{
		...
		dni->static_position = (p->beta*p->a/det_a + (1.0-p->beta)*p->r)*(dni->coordinate - p->original_center) + p->current_center;
		if (!dni->mapped_node->flag_anchor_node)
		{
			Vector3d _force = dni->force + force_gravity + force_wind;
			dni->target_position = dni->static_position + time_step_size * time_step_size * _force * force_scalar;
...
bool Kernel::simulateNextStep4AdaptiveShapeMatching()
{
	double mass_sum = 0.0;
	num_PE_perTimeStep = 0;
	Vector3d force_gravity = Vector3d::Zero();
	...
	for (n = 0; n < level_list.size(); n++)
	{
		...
		// preprocessing
		level_list[n]->voxmesh_level->cluster_adaptive_list.clear();
		vector<Cluster>::iterator ci = level_list[n]->voxmesh_level->cluster_list.begin();
		//find active, leaf, inheritance cells
		for (; ci != level_list[n]->voxmesh_level->cluster_list.end(); ++ci)
		{
			if (n > 0)
			{
				if (ci->parent_cluster->flag_leafCluster )
				{
					ci->flag_activeCluster = false;
					ci->flag_leafCluster = false;
				}
				else
				{
					if (!ci->parent_cluster->flag_activeCluster)
					{
						ci->flag_activeCluster = false;
						ci->flag_leafCluster = false;
					}
				...
				ci->flag_inheritanceCluster = false;
			}

			if (ci->flag_activeCluster && !ci->flag_leafCluster)
			{
				if (ci->num_stable_children == ci->cluster_list_children.size())
				{
					ci->flag_leafCluster = true;
					if (!linkNode4LeafChildren(&(*ci), force_gravity, force_wind))
					{
						cout << "Error1 when linking node for leaf children" << endl;
						return false;
					}
					ci->computeCurrentMassCentroid4Static();
				}
			}
			ci->num_stable_children = 0;
			if (ci->flag_leafCluster)
			{
				level_list[n]->voxmesh_level->cluster_adaptive_list.push_back(&(*ci));
				if (n > 0)
				{
					for (vector<Cluster *>::iterator nci = ci->neighbor_list.begin(); nci != ci->neighbor_list.end(); nci++)
					{
						if(!(*nci)->flag_activeCluster)
							(*nci)->flag_inheritanceCluster = true;
					}
				}
			}
		}
		//for leaf, leave it;
		//for active & non-leaf, update from leaf
		//for inheritance & non-active, inheritance
		for (ci = level_list[n]->voxmesh_level->cluster_list.begin(); ci != level_list[n]->voxmesh_level->cluster_list.end(); ++ci)
		{
			if (ci->flag_leafCluster)
				continue;

			if (ci->flag_activeCluster)
			{
				if (!linkNode4LeafChildren(&(*ci)))
				{
					cout << "Error2 when linking node for leaf children" << endl;
					return false;
				}
			}

			if (ci->flag_inheritanceCluster)
			{
				if(!linkNode4LeafParent(&(*ci), force_gravity, force_wind))
		...
		for (node_iterator ni=level_list[n]->voxmesh_level->node_list.begin(); ni!=level_list[n]->voxmesh_level->node_list.end(); ++ni)
		{
			bool isNeedAvg = false;
			for (int i = 0; i < ni->incident_cluster.size(); i++)
			{
				if(ni->incident_cluster[i]->flag_leafCluster)
				{
					isNeedAvg = true;
					break;
				}
		...
		//after hsm,decide clusters which is beyond energy, from default level
		level_list[n]->voxmesh_level->old_energy = level_list[n]->voxmesh_level->new_energy;
		level_list[n]->voxmesh_level->new_energy = 0.0;
		vector<Cluster *>::iterator aci;
		for ( aci = level_list[n]->voxmesh_level->cluster_adaptive_list.begin(); aci != level_list[n]->voxmesh_level->cluster_adaptive_list.end(); ++aci)
		{
			double match_energy = 0.0;
			for (int j = 0; j < (*aci)->num_node; ++j)
			{
				match_energy += ((*aci)->node_list[j].static_position - (*aci)->node_list[j].target_position).norm();
			}
			//cout << match_energy << endl;
			//if energy is beyond threshold, then divide
			if (match_energy > threshold_energy)
			{
				if ((*aci)->flag_leafCluster)
				{
					if ((*aci)->cluster_list_children.size() > 0)
					{
						for (int j = 0; j < (*aci)->cluster_list_children.size(); j ++)
						{
							(*aci)->cluster_list_children[j]->flag_leafCluster = true;
							(*aci)->cluster_list_children[j]->flag_activeCluster = true;
							if(!linkNode4LeafParent((*aci)->cluster_list_children[j], force_gravity, force_wind))
								cout << "divide" << endl;
						}
						(*aci)->flag_leafCluster = false;
					}
				}
			}
			else if (match_energy <= (0.5*threshold_energy))
			{
				if (!(*aci)->flag_leafCluster)
				{
					(*aci)->flag_leafCluster = true;
				}
				else
				{
					if ((*aci)->parent_cluster)
					{
						(*aci)->parent_cluster->num_stable_children += 1;
					}
				}
			}
			//compute energy
			if(flag_setForce && !flag_setWindForce)
			{
				if ((*aci)->flag_leafCluster)
				{
					level_list[n]->voxmesh_level->new_energy += match_energy;
				}
			}
		}
		///////////////////////////
	...
	for (n = 0; n < level_list.size(); n++)
	{
		...
		//{
			//*********************** adaptive ***********
			if (level_list[n]->voxmesh_level->cluster_adaptive_list.empty())
				continue;
			vector<Cluster *>::iterator ci = level_list[n]->voxmesh_level->cluster_adaptive_list.begin();
			for (; ci != level_list[n]->voxmesh_level->cluster_adaptive_list.end(); ++ci)
			//*********************** adaptive ***********
			{
				vector<DuplicatedNode>::const_iterator const_ni;
	...
	for (node_iterator nmi = p_mesh->node_list.begin(); nmi != p_mesh->node_list.end(); ++nmi)
	{
		nmi->displacement.setZero();
		int level_index = 0;
		for(int j = 0; j < nmi->incident_cluster.size(); j++)
		{
			if(nmi->incident_cluster[j]->flag_leafCluster)
			{
				level_index = j;
				break;
			}
		...
		for(int i = 0; i < 8; i++)
		{
			//nmi->displacement += nmi->list_interpolation_nodes[i][level_index]->displacement * nmi->para_interpolate[i][level_index];
			nmi->displacement += (nmi->list_interpolation_nodes[i][level_index]->target_position - nmi->list_interpolation_nodes[i][level_index]->coordinate) * nmi->para_interpolate[i][level_index];
		}
	}

	//time_counter->StopCounter();
	//cout << "Iterpolation: " << time_counter->GetElapsedTime() << endl;
	...
	if (flag_setForce && !flag_setWindForce)
	{
		...
		double newTotal = 0.0;
		runtime += time_counter->GetElapsedTime();
		peNum += num_PE_perTimeStep;
		for (int i = threshold_leaf_level; i < level_list.size(); i++)
		{
			
			oldTotal += level_list[i]->voxmesh_level->old_energy;
			newTotal += level_list[i]->voxmesh_level->new_energy;
		}
		if(oldTotal != 0)
		{
			double threshold = (newTotal - oldTotal)/ oldTotal;
			if(/*threshold < 0 &&*/ abs(threshold) < 0.001 && !flag_converge)
			{
				timestep_converge = time_step_index;
				flag_converge = true;
				cout << "TimeStep:" << time_step_index << " Converge!" << endl;
				...
				cout << "Converge TimeStep: " << timestep_converge << endl;
				cout << "Iteration #: " << timestep_converge - timestep_begin << endl;
				cout << "PE per Iteration:" << peNum << endl;
				cout << "runtime:" << runtime << endl;
			}
			myHEnergy << newTotal << endl;
			//cout << newTotal << endl;
		}
	}
	/*
...
bool Kernel::simulateNextStep4NewHierarchyShapeMatching()
{
...
{	
	...
	for (node_iterator nmi=p_mesh->node_list.begin(); nmi!=p_mesh->node_list.end(); ++nmi)
	{
		...
		for(int i = 0; i < 8; i++)
		{
			nmi->displacement += nmi->list_interpolation_nodes[i][idx_bottom]->displacement * nmi->para_interpolate[i][idx_bottom];
			//nmi->displacement += (nmi->list_interpolation_nodes[i][]->target_position - nmi->list_interpolation_nodes[i][level_index]->coordinate) * nmi->para_interpolate[i][level_index];
		}
	}
...
bool Kernel::simulateNextStep4AdaptiveHierarchyShapeMatching()
{
	double mass_sum = 0.0;
	num_PE_perTimeStep = 0;
	Vector3d force_gravity = Vector3d::Zero();
	...
	for (int n = 0; n < level_list.size(); n++)
	{
		...
		//time_counter->StopCounter();
		//cout << n << " initialize: " << time_counter->GetElapsedTime() << endl;
		...
		if(n > 0)
		{
			...
			for (; ci != level_list[n]->voxmesh_level->cluster_list.end(); ++ci)
			{
				...
				{
					level_list[n]->voxmesh_level->cluster_adaptive_list.push_back(&(*ci));
					ci->flag_inheritanceCluster = true;
					for (vector<Cluster *>::iterator nci = ci->neighbor_list.begin(); nci != ci->neighbor_list.end(); nci++)
					{
						(*nci)->flag_inheritanceCluster = true;
					}
			...
			for (ci = level_list[n]->voxmesh_level->cluster_list.begin(); ci != level_list[n]->voxmesh_level->cluster_list.end(); ++ci)
			{
				...
				ci->computeCurrentMassCentroid4Target();
				//time_counter->StopCounter();
				//temp1 += time_counter->GetElapsedTime();
				////////////////////////////////////////////////////////////////////////////////////////
				//slerp to interpolate rotation q_c
				//linear interpolate translation t_ci(which is not used, so deleted)
				////////////////////////////////////////////////////////////////////////////////////////
				...
				//time_counter->StopCounter();
				//temp2 += time_counter->GetElapsedTime();
				...
				//time_counter->StopCounter();
				//temp3 += time_counter->GetElapsedTime();
				//ci->original_center = ci->current_center;
			}
			//cout << temp1 << endl;
			//cout << temp2 << endl;
			...
			//time_counter->StopCounter();
			//cout << n << " inheritance_step1: " << time_counter->GetElapsedTime() << endl;
			//time_counter->StartCounter();
			// updating target position
			//int count = 0;
			for (node_iterator ni=level_list[n]->voxmesh_level->node_list.begin(); ni!=level_list[n]->voxmesh_level->node_list.end(); ++ni)
			{
				...
				for (int i = 0; i < ni->incident_cluster.size(); i++)
				{
					if(ni->incident_cluster[i]->flag_activeCluster)
					{
						isNeedAvg = true;
						break;
					}
			...
			//cout << count << endl;
			//time_counter->StopCounter();
			//cout << n << " inheritance_step2: " << time_counter->GetElapsedTime() << endl;
		}

		//time_counter->StopCounter();
		//cout << n << " inheritance: " << time_counter->GetElapsedTime() << endl;
		...
		//else//if n == 0
		{
			...
			if(n == 0 || n < level_list.size())
			{
			 	for( int i = 0; i < iteration; i ++)
				{
					...
					//time_counter->StartCounter();
					//after hsm,decide clusters which is beyond energy, from default level
					if(n >= threshold_leaf_level)
					//if(n >= 1)
					{
						level_list[n]->voxmesh_level->old_energy = level_list[n]->voxmesh_level->new_energy;
						level_list[n]->voxmesh_level->new_energy = 0.0;
						for ( ci = level_list[n]->voxmesh_level->cluster_adaptive_list.begin(); ci != level_list[n]->voxmesh_level->cluster_adaptive_list.end(); ++ci)
						{
							double match_energy = 0.0;
							for (int j = 0; j < (*ci)->num_node; ++j)
							{
								match_energy += ((*ci)->node_list[j].static_position - (*ci)->node_list[j].target_position).norm();
							}
							//cout << match_energy << endl;
							//if energy is beyond threshold, then divide
							if (match_energy > threshold_energy)
							{
								if ((*ci)->flag_leafCluster)
								{
									...
									{
										(*ci)->flag_leafCluster = false;
										//cout << n << " non-leaf:" << (*ci)->cluster_list_children.size() << endl;
										for (int j = 0; j < (*ci)->cluster_list_children.size(); j ++)
										{
											(*ci)->cluster_list_children[j]->flag_leafCluster = true;
											(*ci)->cluster_list_children[j]->flag_activeCluster = true;
										}
									}
								}
							}
							else if (match_energy <= threshold_energy)
							{
								if (!(*ci)->flag_leafCluster)
								{
									(*ci)->flag_leafCluster = true;
							...
							if ((*ci)->flag_leafCluster)
							{
								//leaf_cluster_list.push_back((*ci));
								if ((*ci)->super_parent_cluster)
								{
									(*ci)->super_parent_cluster->leaf_list.push_back((*ci));
									(*ci)->super_parent_cluster->term_normlize += (*ci)->distanceSuperParent;
								}
							}
							//adaptive
		...
		//time_counter->StopCounter();
		//cout << n << " sm: " << time_counter->GetElapsedTime() << endl;
	}
	...
	if(level_list.size() > 1 && flag_multigrid)
	{
		...
		int size_c = level_list[0]->voxmesh_level->cluster_list.size();
		//cout << time_step_index << ":";
		for(int i_c = 0; i_c < size_c; i_c ++)
		{
			Cluster * m_pcluster = &level_list[0]->voxmesh_level->cluster_list[i_c];
			Vector3d translation = Vector3d::Zero();
			int sizeLeaf = m_pcluster->leaf_list.size();
			//cout << i_c << "has " << sizeLeaf << " ";
			if (sizeLeaf < 1)
				continue;
			if (sizeLeaf > 1)
			{
				...
				while(count < sizeLeaf)
				{
					...
					double temp = t_add / (t_add + (m_pcluster->leaf_list[count -1]->distanceSuperParent / m_pcluster->term_normlize));
					Quaterniond qtemp = q2.slerp(temp, q);
					q = qtemp;
	...
	//cout << " feedback: " << time_counter->GetElapsedTime() << endl;
...
{ 
	if (p_vox_mesh->active_node[0])
	{
		for (int i=0; i<p_vox_mesh->active_node[0]->duplicates.size(); ++i)
		{
			p_vox_mesh->active_node[0]->duplicates[i]->target_position = p_vox_mesh->active_node[0]->duplicates[i]->coordinate + p_vox_mesh->active_node[0]->force; 
		}
	}
	if (p_vox_mesh->active_node[1])
	{
		for (int i=0; i<p_vox_mesh->active_node[1]->duplicates.size(); ++i)
		{
			p_vox_mesh->active_node[1]->duplicates[i]->target_position = p_vox_mesh->active_node[1]->duplicates[i]->coordinate + p_vox_mesh->active_node[1]->force; 
		}
	}
...
bool Kernel::simulateNextStep()
{
	...
	case HIERARCHY_SHAPE_MATCHING:
		...
		break;
	case NEW_HIERARCHY_SHAPE_MATCHING:
		return simulateNextStep4NewHierarchyShapeMatching();
		break;
	case ADAPTIVE_HIERARCHY_SHAPE_MATCHING:
		return simulateNextStep4AdaptiveHierarchyShapeMatching();
		break;
	case ADAPTIVE_SHAPE_MATCHING:
		return simulateNextStep4AdaptiveShapeMatching();
		break;
	case SIMULATION_NETWORKING:
...
void Kernel::generateVoxMesh4Level(int level, int d)
{
	if(level == 0)
	{
		...
		cout << "linking neighbors... ";
		linkNeighbor4Cluster(p_vox_mesh);
		cout << "done" << endl;
		...
		generatePerVoxCluster4Level(v_mesh, level_list[parent_index]->voxmesh_level, level);
...
void Kernel::generatePerVoxCluster4Level(VoxMesh* &vm, VoxMesh* &parent_mesh, int levelIndex)
{ 
	for (node_iterator ni=vm->node_list.begin(); ni!=vm->node_list.end(); ++ni)
	{
	...
	if (used_simulator == Kernel::HIERARCHY_SHAPE_MATCHING)
	{
		for (ci = level_list[0]->voxmesh_level->cluster_list.begin(); ci != level_list[0]->voxmesh_level->cluster_list.end(); ++ci)
		{
			ci->leaf_list.clear();
			ci->term_normlize = 0.0;
		}
	}
	else if (used_simulator == Kernel::ADAPTIVE_HIERARCHY_SHAPE_MATCHING || used_simulator == Kernel::ADAPTIVE_SHAPE_MATCHING)
	{
		if(levelIndex == threshold_leaf_level)
		{
			for (ci = level_list[0]->voxmesh_level->cluster_list.begin(); ci != level_list[0]->voxmesh_level->cluster_list.end(); ++ci)
			{
				ci->leaf_list.clear();
	...
	{	
		...
		{
			vm->cluster_list.back().flag_leafCluster = true;
			parent_mesh->cluster_list[vi->parent_vox->clusterid].flag_leafCluster = false;
		}
		vm->cluster_list.back().index = vm->cluster_list.size() - 1;
		// ** adaptive **
		...
		//compute distance from this cluster center to its super parent center
		double para = 0.0;
		para += pow((vm->cluster_list.back().super_parent_cluster->original_center(0) - vm->cluster_list.back().original_center(0)), 2);
		para += pow((vm->cluster_list.back().super_parent_cluster->original_center(1) - vm->cluster_list.back().original_center(1)), 2);
		para += pow((vm->cluster_list.back().super_parent_cluster->original_center(2) - vm->cluster_list.back().original_center(2)), 2);

		if(para == 0)
			para = 0.0001;

		vm->cluster_list.back().distanceSuperParent = 1.0 / para;
		//* adaptive *
		if (used_simulator == Kernel::HIERARCHY_SHAPE_MATCHING)
		{
			vm->cluster_list.back().super_parent_cluster->leaf_list.push_back(&vm->cluster_list.back());
			vm->cluster_list.back().super_parent_cluster->term_normlize += vm->cluster_list.back().distanceSuperParent;
		}
		else if (used_simulator == Kernel::ADAPTIVE_HIERARCHY_SHAPE_MATCHING || used_simulator == Kernel::ADAPTIVE_SHAPE_MATCHING)
		{
			if (levelIndex == threshold_leaf_level)
	...
	/*
	if(threshold_leaf_level == levelIndex)
	{
		for (ci = level_list[0]->voxmesh_level->cluster_list.begin(); ci != level_list[0]->voxmesh_level->cluster_list.end(); ++ci)
		{
			...
			{
				Cluster * p_leaf = ci->leaf_list[i_l];

				double para = 0.0;
				para += pow((ci->original_center(0) - p_leaf->original_center(0)), 2);
				para += pow((ci->original_center(1) - p_leaf->original_center(1)), 2);
				para += pow((ci->original_center(2) - p_leaf->original_center(2)), 2);
...
void Kernel::setGoalPos4HapticNode(Vector3d goalposition)
{
	if (level_list[0]->voxmesh_level->haptic_node_list.size() > 0)
	{
		vector<Node>::iterator ni = level_list[0]->voxmesh_level->haptic_node_list.begin();
		for (; ni!= level_list[0]->voxmesh_level->haptic_node_list.end(); ni++)
		{
			ni->target_position = goalposition;
			vector<DuplicatedNode *>::iterator di = ni->duplicates.begin();
			for (; di != ni->duplicates.end(); di ++)
			{
				(*di)->target_position = goalposition;
			}
		}
	}
}
void Kernel::setHapticNode(int idx_triangle, Vector3d coordinate)
{
	Node new_node0;
	new_node0.coordinate =coordinate;
	new_node0.static_position = new_node0.coordinate;
	new_node0.target_position = new_node0.coordinate;
	new_node0.incident_cluster.push_back(p_mesh->face_list[idx_triangle].node0->incident_cluster[0]);
	level_list[0]->voxmesh_level->haptic_node_list.push_back(new_node0);
	DuplicatedNode new_node_0(&level_list[0]->voxmesh_level->haptic_node_list.back());
	new_node_0.static_position = new_node0.coordinate;
	new_node_0.target_position = new_node0.coordinate;
	p_mesh->face_list[idx_triangle].node0->incident_cluster[0]->haptic_node_list.push_back(new_node_0);
	level_list[0]->voxmesh_level->haptic_node_list.back().duplicates.push_back(&p_mesh->face_list[idx_triangle].node0->incident_cluster[0]->haptic_node_list.back());

	Node ghost_node0;
	ghost_node0.coordinate = coordinate;
	ghost_node0.coordinate = 2* p_mesh->face_list[idx_triangle].node0->incident_cluster[0]->current_center - ghost_node0.coordinate;
	ghost_node0.static_position = ghost_node0.coordinate;
	ghost_node0.target_position = ghost_node0.coordinate;
	ghost_node0.incident_cluster.push_back(p_mesh->face_list[idx_triangle].node0->incident_cluster[0]);
	level_list[0]->voxmesh_level->ghost_node_list.push_back(ghost_node0);
	DuplicatedNode ghost_node_0(&level_list[0]->voxmesh_level->ghost_node_list.back());
	ghost_node_0.static_position = ghost_node0.coordinate;
...
void Kernel::setHapticNode(int idx_triangle)
{
	...
	Node ghost_node0;
	ghost_node0.coordinate = p_mesh->face_list[idx_triangle].node0->coordinate + p_mesh->face_list[idx_triangle].node0->displacement;
	ghost_node0.coordinate = 2* p_mesh->face_list[idx_triangle].node0->incident_cluster[0]->current_center - ghost_node0.coordinate;
	ghost_node0.static_position = ghost_node0.coordinate;
	ghost_node0.target_position = ghost_node0.coordinate;
	ghost_node0.incident_cluster.push_back(p_mesh->face_list[idx_triangle].node0->incident_cluster[0]);
	...
	/*
	Node new_node1;
	new_node1.coordinate = p_mesh->face_list[idx_triangle].node1->coordinate + p_mesh->face_list[idx_triangle].node1->displacement;
	new_node1.static_position = new_node1.coordinate;
	new_node1.target_position = new_node1.coordinate;
	new_node1.incident_cluster.push_back(p_mesh->face_list[idx_triangle].node1->incident_cluster[0]);
	level_list[0]->voxmesh_level->haptic_node_list.push_back(new_node1);
	DuplicatedNode new_node_1(&level_list[0]->voxmesh_level->haptic_node_list.back());
	p_mesh->face_list[idx_triangle].node1->incident_cluster[0]->haptic_node_list.push_back(new_node_1);
	level_list[0]->voxmesh_level->haptic_node_list.back().duplicates.push_back(&p_mesh->face_list[idx_triangle].node1->incident_cluster[0]->haptic_node_list.back());

	Node ghost_node1;
	ghost_node1.coordinate = p_mesh->face_list[idx_triangle].node1->coordinate + p_mesh->face_list[idx_triangle].node1->displacement;
	ghost_node1.coordinate = 2* p_mesh->face_list[idx_triangle].node1->incident_cluster[0]->current_center - ghost_node1.coordinate;
	ghost_node1.static_position = ghost_node1.coordinate;
	ghost_node1.target_position = ghost_node1.coordinate;
	ghost_node1.incident_cluster.push_back(p_mesh->face_list[idx_triangle].node1->incident_cluster[0]);
	level_list[0]->voxmesh_level->haptic_node_list.push_back(ghost_node1);
	DuplicatedNode ghost_node_1(&level_list[0]->voxmesh_level->haptic_node_list.back());
	p_mesh->face_list[idx_triangle].node1->incident_cluster[0]->haptic_node_list.push_back(ghost_node_1);
	level_list[0]->voxmesh_level->haptic_node_list.back().duplicates.push_back(&p_mesh->face_list[idx_triangle].node1->incident_cluster[0]->haptic_node_list.back());

	Node new_node2;
	new_node2.coordinate = p_mesh->face_list[idx_triangle].node2->coordinate + p_mesh->face_list[idx_triangle].node2->displacement;
	new_node2.static_position = new_node2.coordinate;
	new_node2.target_position = new_node2.coordinate;
	new_node2.incident_cluster.push_back(p_mesh->face_list[idx_triangle].node2->incident_cluster[0]);
	level_list[0]->voxmesh_level->haptic_node_list.push_back(new_node2);
	DuplicatedNode new_node_2(&level_list[0]->voxmesh_level->haptic_node_list.back());
	p_mesh->face_list[idx_triangle].node2->incident_cluster[0]->haptic_node_list.push_back(new_node_2);
	level_list[0]->voxmesh_level->haptic_node_list.back().duplicates.push_back(&p_mesh->face_list[idx_triangle].node2->incident_cluster[0]->haptic_node_list.back());

	Node ghost_node2;
	ghost_node2.coordinate = p_mesh->face_list[idx_triangle].node2->coordinate + p_mesh->face_list[idx_triangle].node2->displacement;
	ghost_node2.coordinate = 2* p_mesh->face_list[idx_triangle].node2->incident_cluster[0]->current_center - ghost_node2.coordinate;
	ghost_node2.static_position = ghost_node2.coordinate;
	ghost_node2.target_position = ghost_node2.coordinate;
	ghost_node2.incident_cluster.push_back(p_mesh->face_list[idx_triangle].node2->incident_cluster[0]);
	level_list[0]->voxmesh_level->haptic_node_list.push_back(ghost_node2);
	DuplicatedNode ghost_node_2(&level_list[0]->voxmesh_level->haptic_node_list.back());
	p_mesh->face_list[idx_triangle].node2->incident_cluster[0]->haptic_node_list.push_back(ghost_node_2);
	level_list[0]->voxmesh_level->haptic_node_list.back().duplicates.push_back(&p_mesh->face_list[idx_triangle].node2->incident_cluster[0]->haptic_node_list.back());
	*/
}


bool Kernel::getForce4HapticNode(Vector3d & force)
{
	//cout << level_list[0]->voxmesh_level->haptic_node_list.size() << endl;
	if (level_list[0]->voxmesh_level->haptic_node_list.size() > 0)
	{
		force = level_list[0]->voxmesh_level->haptic_node_list[0].static_position - level_list[0]->voxmesh_level->haptic_node_list[0].target_position;
		//force = level_list[0]->voxmesh_level->haptic_node_list[0].mass * force;
		//cout << level_list[0]->voxmesh_level->haptic_node_list[0].static_position << endl;
		//cout << level_list[0]->voxmesh_level->haptic_node_list[0].target_position << endl;
...
bool Kernel::getPos4HapticNode(Vector3d & pos)
{
	if (level_list[0]->voxmesh_level->haptic_node_list.size() > 0)
	{
		pos = level_list[0]->voxmesh_level->haptic_node_list[0].static_position;
		return true;
	}
	else
	{
