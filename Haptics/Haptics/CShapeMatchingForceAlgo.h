...
//---------------------------------------------------------------------------
#ifndef CShapeMatchingForceAlgoH
#define CShapeMatchingForceAlgoH
//---------------------------------------------------------------------------
...
//===========================================================================
/*!
    \file       cShapeMatchingForceAlgo.h
...
*/
//===========================================================================
class cShapeMatchingForceAlgo : public cGenericPointForceAlgo
{
  public:
    //-----------------------------------------------------------------------
    ...
    cShapeMatchingForceAlgo();

    //! Destructor of cShapeMatchingForceAlgo.
    virtual ~cShapeMatchingForceAlgo() {}
