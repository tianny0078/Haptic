...
//===========================================================================
/*!
    Constructor of cShapeMatchingForceAlgo.

    \fn       cShapeMatchingForceAlgo::cShapeMatchingForceAlgo()
*/
//===========================================================================
cShapeMatchingForceAlgo::cShapeMatchingForceAlgo()
{
...
/*!
    ...
    \fn       void cShapeMatchingForceAlgo::initialize(cWorld* a_world, 
...
*/
//===========================================================================
void cShapeMatchingForceAlgo::initialize(cWorld* a_world, const cVector3d& a_initialGlobalPosition)
{
...
/*!
    ...
    \fn       void cShapeMatchingForceAlgo::reset()
*/
//===========================================================================
void cShapeMatchingForceAlgo::reset()
{
    // reset force
    m_lastGlobalForce.zero();
...
/*!
    ...
    \fn       void cShapeMatchingForceAlgo::setEpsilonBaseValue(double a_value)
*/
//===========================================================================
void cShapeMatchingForceAlgo::setEpsilonBaseValue(double a_value)
{
...
/*!
    ...
    \fn       cVector3d cShapeMatchingForceAlgo::computeForces(
...
*/
//===========================================================================
cVector3d cShapeMatchingForceAlgo::computeForces(const cVector3d& a_toolPos,
                                              const cVector3d& a_toolVel)
{
    ...
    if (m_world != NULL)
    {
		...
		//if (!m_proxyGlobalPos.equals(m_deviceGlobalPos))
		//{
		//	std::cout << m_proxyGlobalPos << std::endl;
		//}
...
/*!
    ...
    \fn		void cShapeMatchingForceAlgo::computeNextBestProxyPosition(const cVector3d& a_goal)
	\param  a_goal  The goal towards which to move the proxy, subject to constraints
*/
//===========================================================================
void cShapeMatchingForceAlgo::computeNextBestProxyPosition(const cVector3d& a_goal)
{
...
bool cShapeMatchingForceAlgo::computeNextProxyPositionWithContraints0(const cVector3d& a_goalGlobalPos)
{
...
bool cShapeMatchingForceAlgo::computeNextProxyPositionWithContraints1(const cVector3d& a_goalGlobalPos)
{
...
bool cShapeMatchingForceAlgo::computeNextProxyPositionWithContraints2(const cVector3d& a_goalGlobalPos)
{
...
/*!
    ...
    \fn   virtual bool cShapeMatchingForceAlgo::goalAchieved(const cVector3d& a_proxy, const cVector3d& a_goal) const;
...
*/
//===========================================================================
bool cShapeMatchingForceAlgo::goalAchieved(const cVector3d& a_proxy, const cVector3d& a_goal) const
{
    if (m_useDynamicProxy)
    {
...
/*!
    ...
    \fn   void cShapeMatchingForceAlgo::testFrictionAndMoveProxy(const cVector3d& a_goal, 
...
*/
//===========================================================================
void cShapeMatchingForceAlgo::testFrictionAndMoveProxy(const cVector3d& a_goal, 
													const cVector3d& a_proxy,
													cVector3d& a_normal, 
													cGenericObject* a_parent)
{
...
/*!
    ...
    \fn       void cShapeMatchingForceAlgo::updateForce()
*/
//===========================================================================
void cShapeMatchingForceAlgo::updateForce()
{
