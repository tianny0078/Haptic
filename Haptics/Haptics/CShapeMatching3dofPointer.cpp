...
/*!
    ...
    \fn       cShapeMatching3dofPointer::cShapeMatching3dofPointer(cWorld* a_world)
    \param    a_world  World in which the tool will operate.
*/
//===========================================================================
cShapeMatching3dofPointer::cShapeMatching3dofPointer(cWorld* a_world)
{
    ...
    m_proxyPointForceModel = new cShapeMatchingForceAlgo();
...
/*!
    ...
    \fn       cShapeMatching3dofPointer::~cShapeMatching3dofPointer()
*/
//===========================================================================
cShapeMatching3dofPointer::~cShapeMatching3dofPointer()
{
...
/*!
    ...
    \fn       void cShapeMatching3dofPointer::initialize(const bool a_resetEncoders=false)
...
*/
//===========================================================================
int cShapeMatching3dofPointer::initialize(const bool a_resetEncoders)
{
    // check if device is available
    if (m_device == NULL)
    {
...
/*!
    ...
    \fn       void cShapeMatching3dofPointer::start()
    \return   0 indicates success, non-zero indicates an error
*/
//===========================================================================
int cShapeMatching3dofPointer::start()
{
    // check if device is available
    if (m_device == NULL)
    {
...
/*!
    ...
    \fn       void cShapeMatching3dofPointer::stop()
    \return   0 indicates success, non-zero indicates an error
*/
//===========================================================================
int cShapeMatching3dofPointer::stop()
{
    // check if device is available
...
/*!
    ...
    \fn       void cShapeMatching3dofPointer::setWorkspaceRadius(const double& a_workspaceRadius)
    \param    a_workspaceRadius   Radius of the workspace.
*/
//===========================================================================
void cShapeMatching3dofPointer::setWorkspaceRadius(const double& a_workspaceRadius)
{
...
/*!
    ...
    \fn       void cShapeMatching3dofPointer::setWorkspaceScaleFactor(const double& a_workspaceScaleFactor)
...
/*!
    ...
    \fn       void cShapeMatching3dofPointer::updatePose()
*/
//===========================================================================
...
/*!
    ...
    \fn       void cShapeMatching3dofPointer::computeInteractionForces()
*/
//===========================================================================
void cShapeMatching3dofPointer::computeInteractionForces()
{
...
/*!
    ...
    \fn       void cShapeMatching3dofPointer::applyForces()
*/
//===========================================================================
...
/*!
    ...
    \fn       void cShapeMatching3dofPointer::render(const int a_renderMode=0)
    \param    a_renderMode  rendering mode; see cGenericObject.cpp.
*/
//===========================================================================
void cShapeMatching3dofPointer::render(const int a_renderMode)
{
...
/*!
    ...
    \fn       void cShapeMatching3dofPointer::setRadius(const double& a_radius)
    \param    a_radius  radius of pointer.
*/
//===========================================================================
void cShapeMatching3dofPointer::setRadius(const double& a_radius)
{
...
/*!
    ...
    \fn     void cShapeMatching3dofPointer::setForcesON()
    \return   0 indicates success, non-zero indicates an error

*/
//===========================================================================
int cShapeMatching3dofPointer::setForcesON()
{
    if (!m_forceON)
    {
          m_forceStarted = false;
...
/*!
    ...
    \fn       void cShapeMatching3dofPointer::setForcesOFF()
    \return   0 indicates success, non-zero indicates an error
*/
//===========================================================================
...
/*!
    ...
    \fn       bool cShapeMatching3dofPointer::isInContact(cGenericObject* a_object)
    \return   Return \e true if the tool is interacting with the object
*/
//===========================================================================
bool cShapeMatching3dofPointer::isInContact(cGenericObject* a_object)
{
    //-------------------------------------------------------------------
